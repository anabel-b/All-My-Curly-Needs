...
const product = [
    ...
    price: "$8.12", name: "Maui Curl Quench + Coconut Oil Conditioner", 
    ...
    price: "$9.97", 
    name: "SheaMoisture Jamaican Black Castor Oil Leave In Conditioner", 
  ...
  description: "DEEP NOURISHMENT FOR DAMAGED HAIR: Our nutrient-rich mask fuses biotin with aloe, honey, and a blend of nourishing essential oils to create an intensive reconstructing treatment with a fresh, invigorating scent for dry, brittle, thirsty hair"
    ...
    category: "Accessory", 
    price: "$8.99", 
    name: "Bedsure Satin Pillowcase for Hair and Skin Queen", 
    image: "https://m.media-amazon.com/images/I/717JHp8r6LL._AC_SX679_.jpg"}
  ];
